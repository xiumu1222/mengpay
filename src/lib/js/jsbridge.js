...
(function () {
    ...
    jsapi.app = {
        ...
        startScan: function (param, callback) {
            //调用一个测试函数
            JSBridge.callHandler('startScan', param, function (res) {
        ...
        getUserInfo: function (param, callback) {
            //调用一个测试函数
            JSBridge.callHandler('getUserInfo', param, function (res) {
                callback && callback(res);
            });
        },
        //设置头像
        takePhoto: function (param, callback) {
            //调用一个测试函数
            JSBridge.callHandler('takePhoto', param, function (res) {
                callback && callback(res);
            });
        },
        //相册选择
        galleryPicChoise: function (param, callback) {
            //调用一个测试函数
            JSBridge.callHandler('galleryPicChoise', param, function (res) {
                callback && callback(res);
            });
        },
        //退出登录
        logoutAndBackToLoginView: function (param, callback) {
            //调用一个测试函数
            JSBridge.callHandler('logoutAndBackToLoginView', param, function (res) {
                callback && callback(res);
            });
        },
        //退出登录
        goToZMCertification: function (param, callback) {
            //调用一个测试函数
            /**
             * param:{"url":"******"}
             * */
            JSBridge.callHandler('goToZMCertification', param, function (res) {
                callback && callback(res);
            });
        },
        /**
